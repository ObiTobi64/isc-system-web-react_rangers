...
const validationSchema = Yup.object({
  ...
  phone: Yup.string()
    ...
    .optional(),
  code: Yup.string().test("code-validation", CODE_ERROR_MESSAGE, (value) => {
    if (!value || value.trim() === "") {
      return true;
    }
...
const EditProfessorComponent: FC<{ id: number; onClose: () => void }> = ({ id, onClose }) => {
  ...
  return (
    <FormContainer>
      {loading && <LoadingOverlay message = "Actualizando Docente..." />}
